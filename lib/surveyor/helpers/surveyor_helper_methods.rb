  ...
  module Helpers
    module SurveyorHelperMethods
      ...
      def next_section
        ...
        @sections.last == @section ? submit_tag(t('surveyor.click_here_to_finish').html_safe, :name => "finish", :confirm => "Are you sure you want to finish? You will not be able to edit your responses after submission.") : submit_tag(t('surveyor.next_section').html_safe, :name => "section[#{@sections[next_index].id}]")
      end
